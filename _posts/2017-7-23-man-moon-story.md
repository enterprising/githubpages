...
简单是说就是要把最好的精力和工具放在最难攻克的项目难点上。

关于银弹的介绍：

在所有恐怖民间传说的妖怪中,最可怕的是人狼,因为它们可以完全出乎意料地从熟 悉的面孔变成可怕的怪物。为了对付人狼,我们在寻找可以消灭它们的**银弹**。
...
出现在目前生厂上的，但并非那些与生俱来的困难

高级语言、分时、统一编程环境

三、银弹的希望

高级语言、面向对象编程、人工智能、“自动”编程、图形化编程、程序验证、环境和工具、工作站

四、针对概念上根本问题的颇具前途的方法

购买好自行开发、需求精炼和快速原型、增量开发（增长而非搭建系统）、卓越的设计人员

## 再论《没有银弹》

。。上面大部分内容都是第一版里面的（1975年），这一章属于20周年纪念版（1995年）新增的内容。

大概就是说，它第一版发行之后，收到了很多人的抨击。很多人反对他的这一观点，这里它引用了几篇论文，发表了一些自己的看法。
